...
contract TendToken is ERC20, Ownable {
    ...
    modifier when3DaysBetweenLastSnapshot() {
        require(
            (now - lastRewardTime) >= 3 days,
            "TendToken: not enough days since last snapshot taken."
        );
        _;
    }
    ...
    function setPauser(address newPauser) public onlyOwner {
        require(
            newPauser != address(0),
            "TendToken: pauser is the zero address."
        );
        pauser = newPauser;
    }
    ...
    function _beforeTokenTransfer(
        ...
        require(
            ...
            "TendToken: token transfer while paused and not pauser role."
        );
    }
    ...
    function claimRewards() external {
        require(
            ...
            "TendToken: nothing left to claim."
        );
